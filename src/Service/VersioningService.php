...
class VersioningService
{
    ...
    {
        /**
         * Constu-ructeur permettant de récupérer la requête courante (pour extraire le champ "accept" du header)
...
*/
    public function getVersion(): string
    {
        ...
        // Récupération du numéro de version dans la chaine de caractères "Accept"
        // exemple "application/json; test=bidule; version=2.0" => 2.0

        $entete = explode(';', $accept);

        // On parcours toutes les entêtes pour trouver le numéro de version
